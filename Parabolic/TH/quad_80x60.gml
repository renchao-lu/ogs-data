...
<OpenGeoSysGLI xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.opengeosys.org/images/xsd/OpenGeoSysGLI.xsd" xmlns:ogs="http://www.opengeosys.org">
    ...
    <points>
        <point id="0" x="0" y="0.5" z="0"/>
        <point id="1" x="0" y="1" z="0"/>
        <point id="2" x="0" y="0.6" z="0"/>
        <point id="3" x="0" y="0.9" z="0"/>
        <point id="4" x="0" y="0" z="0"/>
        <point id="5" x="0" y="1.5" z="0"/>
        <point id="6" x="2" y="0" z="0"/>
        <point id="7" x="2" y="1.5" z="0"/>
    </points>
    ...
    <polylines>
        ...
        <polyline id="1" name="left1">
            <pnt>0</pnt>
            <pnt>2</pnt>
        </polyline>
        <polyline id="2" name="left2">
            <pnt>2</pnt>
            <pnt>3</pnt>
        </polyline>
        <polyline id="3" name="left3">
            <pnt>3</pnt>
            <pnt>1</pnt>
        </polyline>
        <polyline id="4" name="leftup">
            <pnt>1</pnt>
            <pnt>5</pnt>
        </polyline>
        <polyline id="5" name="leftdown">
            <pnt>4</pnt>
            <pnt>0</pnt>
        </polyline>
